...
class ShopItemActivity : AppCompatActivity() {
    ...
    private var scoreMode = MODE_UNKNOWN
    ...
    private fun addTextChangListeners() {
    ...
    private fun launchEditMode() {
        ...
        viewModel.shopItem.observe(this) {
            ...
            etCount.setText(it.count.toString()) // если передать саму (it) то то
            // кампелятор подумает что это (id) стороки из троковых ресурсов
        }
        btnSave.setOnClickListener {
